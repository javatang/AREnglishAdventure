...
public:
	...
	// UnityEngine.GameObject Vuforia.DefaultTrackableEventHandler::virtualObj
	GameObject_t1756533147 * ___virtualObj_3;
...
public:
	...
	inline static int32_t get_offset_of_virtualObj_3() { return static_cast<int32_t>(offsetof(DefaultTrackableEventHandler_t1082256726, ___virtualObj_3)); }
	inline GameObject_t1756533147 * get_virtualObj_3() const { return ___virtualObj_3; }
	inline GameObject_t1756533147 ** get_address_of_virtualObj_3() { return &___virtualObj_3; }
	inline void set_virtualObj_3(GameObject_t1756533147 * value)
	{
		___virtualObj_3 = value;
		Il2CppCodeGenWriteBarrier(&___virtualObj_3, value);
	}
};
